...
public class UpdateDriverProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!Places.isInitialized()) {
            Places.initialize(UpdateDriverProfileActivity.this, apiKey);
        }
// Retrieve a PlacesClient (previously initialized - see MainActivity)
        ...
        autocompleteSupportFragment.setOnPlaceSelectedListener(
                new PlaceSelectionListener() {
                    ...
                    public void onError(Status status) {
                        Toast.makeText(UpdateDriverProfileActivity.this, ""+status.getStatusMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        current_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Location_final.setProvider("notdummy");
                Toast.makeText(UpdateDriverProfileActivity.this, "Using Current Location...", Toast.LENGTH_SHORT).show();
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Location_final.getProvider().equals("notdummy") && !phone.getText().toString().isEmpty()) {
                    Log.d("bigtest", db.collection("drivers").document(uid).toString());
                    ...
                    db.collection("drivers").document(uid)
                            ...
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    Toast.makeText(UpdateDriverProfileActivity.this, "Profile Updated Successfully!", Toast.LENGTH_SHORT).show();
                                }
                            })
                            .addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(UpdateDriverProfileActivity.this, "Error " + e, Toast.LENGTH_SHORT).show();
                                }
                            });
                                ...
                                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                    if(task.isSuccessful()){
                                        ...
                                        if(documentSnapshot.get("rating") == null){
                                            ...
                                            ratings.put("rating", 4.5);
                                            ratings.put("orders", 5);
                                            db.collection("drivers").document(uid)
                                                    .set(ratings, SetOptions.merge());
                                        }
                                        if(documentSnapshot.get("Active Bookings") == null){
                                            Map <String, Object> activeBookings = new HashMap<>();
                                            activeBookings.put("Active Bookings", 0);
                                            activeBookings.put("Active Regular Bookings", 0);
                                            db.collection("drivers").document(uid)
                                                    .set(activeBookings, SetOptions.merge());
                                        }
                                    }
                                }
                            });
                    ...
                    Toast.makeText(UpdateDriverProfileActivity.this, "Some fields are empty, please check",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
